<template>
  ...
  <div class="indexnew1">
            ...
            <span class="toprc">
                  <el-dropdown  trigger="click" @command="handleCommand">
                    <span class="cursor">  <i class="el-icon-user-solid"></i>  {{name}} 
                      (<span style="font-size:12px;"> {{orgname}} ，{{zwname}}</span>)</span>
      ...
      <div class="center" :class="first?'inba':'inba1'">
          ...
          <el-row style="margin-bottom:30px;"><el-col :span="24">
             ...
             <div style="float:left;margin-left:10px;">
                   <div style="height: 192px;">
                    ...
                    <div style="margin-top:10px;height: 195px;">
                          ...
                          @click="getZX('c7533b751b0f11eaabae00155dbaef87')"><img src="../assets/img/index/img4.png" alt="联络工作"></span>
                          <span class="fk" style="float: left;height: 195px;" 
                          @click="getZX('c752782a1b0f11eaabae00155dbaef87')"><img src="../assets/img/index/img5.png"  alt="统计信息"></span>
                     </div>
           </div>
           </el-col>
