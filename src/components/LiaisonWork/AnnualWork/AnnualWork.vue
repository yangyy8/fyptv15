               ...
               <div class="pborder">
                   <el-row class="ah-50">
                        <el-col :span="24">
                           ...
                           <el-input placeholder="请输入内容" size="small" clearable v-model="form.theme"  class="yy-input-input" style="width:90%!important;" ></el-input>
                       </el-col>
                        <el-col :span="24">
                           <span class="yy-input-text" style="width:6.8%">文件类型</span>
                        <el-select v-model="form.workRelFileType" filterable clearable default-first-option placeholder="请选择"  size="small" class="yy-input-input"  style="width:20%!important;">
                               <el-option
                              ...
                              <el-table-column
                                  ...
                                  <template slot-scope="scope">
                                    <div>
                                      ...
                                      <el-button type="text"  class="a-btn"  title="删除"  icon="el-icon-delete" @click="delfile(scope.row,fileList)"></el-button>
                                    </div>
                                  </template>
                              </el-table-column>
                             </el-table>
                       ...
                       <el-col :span="6">
                           ...
                           <el-input placeholder="请输入内容" size="small" clearable v-model="form.lrdw"  :disabled="true"  class="yy-input-input" ></el-input>
                        </el-col>
                        <el-col :span="6">
                           <span class="yy-input-text">录入部门</span>
                           <el-input placeholder="请输入内容" size="small" clearable v-model="form.lrbm"  :disabled="true"  class="yy-input-input" ></el-input>
                        </el-col>
                        <el-col :span="6">
                           <span class="yy-input-text">录入人</span>
                           <el-input placeholder="请输入内容" size="small" clearable v-model="form.lrr"  :disabled="true" class="yy-input-input" ></el-input>
                        </el-col>
                        <el-col :span="6">
                           <span class="yy-input-text">录入时间</span>
                           <el-input placeholder="请输入内容" size="small" clearable v-model="form.lrsj"  :disabled="true" class="yy-input-input" ></el-input>
                        </el-col>
                    </el-row>
                </div>
