   ...
   
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: resolve => require(['@/components/LiaisonWork/WorkDoc/StandardList'], resolve),
        },
        // Information(基本信息)  BaseInfo(基本信息)  
        {
          path: 'BaseAdd',
          name: 'BaseAdd',
          meta:{title:['基本信息','全部基本信息录入']},
          component: resolve => require(['@/components/Information/BaseInfo/BaseAdd'], resolve),
        },
        {
          path: 'BaseLook',
          name: 'BaseLook',
          meta:{title:['基本信息','基本信息查看']},
          component: resolve => require(['@/components/Information/BaseInfo/BaseLook'], resolve),
        },
        {
          path: 'AreaList',
          name: 'AreaList',
          meta:{title:['基本信息','行政区划']},
        ...
        },
        {
          ...
          meta:{title:['基本信息','法院内部管理',"法院人员高级查询"]},
       ...
       //监控和预警
        ...
        },
        {
          path: 'Comprehensive',
          name: 'Comprehensive',
          meta:{title:['统计查询','综合统计分析']},
          component: resolve => require(['@/components/Analysis/Comprehensive'], resolve),
        },
        {
          path: 'RosterList',
          name: 'RosterList',
          meta:{title:['基本对象','连任或重名名单查询']},
          component: resolve => require(['@/components/Analysis/RosterList'], resolve),
        },
